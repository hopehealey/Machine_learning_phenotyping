...
class TestModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        self.netAUX = torchvision.models.resnet18(pretrained = False, num_classes=5)
        self.netAUX.load_state_dict(torch.load(opt.aux_checkpoint))

        device = torch.device('cuda' if torch.cuda.is_available() else 'cpu')
        self.netAUX.to(device)
    ...
    def forward(self):
        ...
        self.aux_real = self.netAUX(self.real)
        self.aux_fake = self.netAUX(self.fake)
