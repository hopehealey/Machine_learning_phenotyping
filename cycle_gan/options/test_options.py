...
class TestOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--aux_input_nc', type=int, default=3, help='AUX net input channels')
        parser.add_argument('--aux_output_classes', type=int, default=5, help='AUX number of output classes')
